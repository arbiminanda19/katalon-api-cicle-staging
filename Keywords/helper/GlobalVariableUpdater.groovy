...
public class GlobalVariableUpdater {
	...
	@Keyword
	def static void updatePermanentlyForCurrent(String varName, String newValue) {
		updatePermanently(RunConfiguration.getExecutionProfile(), varName, newValue)
	}

	@Keyword
	def static void updatePermanently(String envName, String varName, String newValue) {
